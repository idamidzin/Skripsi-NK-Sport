...
public class RecyclerViewAdapterFitnessToolHorizontal extends RecyclerView.Adapter<RecyclerViewAdapterFitnessToolHorizontal.MyViewHolder> {

    private Context mContext;
    private List<FitnessTool> mData;

    public RecyclerViewAdapterFitnessToolHorizontal(Context mContext, List<FitnessTool> mData) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterFitnessToolHorizontal.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater=LayoutInflater.from(mContext);
        view = inflater.inflate(R.layout.item_alat_fitness_horizontal,parent,false);

        return new RecyclerViewAdapterFitnessToolHorizontal.MyViewHolder(view);
    }
