...
public class RecyclerViewAdapterPromoVertical extends RecyclerView.Adapter<RecyclerViewAdapterPromoVertical.MyViewHolder> {

    private Context mContext;
    private List<Promo> mData;

    public RecyclerViewAdapterPromoVertical(Context mContext, List<Promo> mData) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterPromoVertical.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater=LayoutInflater.from(mContext);
        view = inflater.inflate(R.layout.item_promo_horizontal,parent,false);

        return new RecyclerViewAdapterPromoVertical.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterPromoVertical.MyViewHolder holder, int position) {
        ...
        holder.btn_promo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("firstOpen","detailPaket");
